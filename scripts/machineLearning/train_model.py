...
optimal_tree_both = DecisionTreeClassifier(max_depth=13)
...
train_and_save_model(gauss_angles, train_data_angles, '/Users/lucapomer/Documents/bachelor/YogaPoseDetection/models/Gauss_optimal_angles.sav')
train_and_save_model(gauss_dist, train_data_dist, '/Users/lucapomer/Documents/bachelor/YogaPoseDetection/models/Gauss_optimal_dist.sav')
...
mlp_dist = MLPClassifier(activation='relu', alpha=0.0001, hidden_layer_sizes=100, learning_rate='constant',
                    max_iter=5000, solver='adam')
mlp_both = MLPClassifier(activation='logistic', alpha=0.0001, hidden_layer_sizes=100, learning_rate='constant',
