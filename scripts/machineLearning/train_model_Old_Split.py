...
csv_folder = '/Users/lucapomer/Documents/bachelor/YogaPoseDetection/old_split_run_through/csv_data_files'
...
model_foler = '/Users/lucapomer/Documents/bachelor/YogaPoseDetection/models/original_split_regular_models'
...
optimal_tree_dist = DecisionTreeClassifier(max_depth=18)
...
gauss_dist = GaussianProcessClassifier(kernel=1**2 * RationalQuadratic(alpha=1, length_scale=1), max_iter_predict=100)
gauss_both = GaussianProcessClassifier(kernel=1**2 * RationalQuadratic(alpha=1, length_scale=1), max_iter_predict=100)
...
mlp_angles = MLPClassifier(activation='logistic', alpha=0.05, hidden_layer_sizes=100,
              learning_rate='adaptive', max_iter=10000, solver='adam')
mlp_dist = MLPClassifier(hidden_layer_sizes=100, max_iter=10000, solver='adam')
mlp_both = MLPClassifier(activation='logistic', hidden_layer_sizes=100, max_iter=1000, solver='adam')
