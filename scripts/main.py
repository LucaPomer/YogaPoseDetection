...
from scripts.helpers.data_creation_helpers import run_openpose_and_distance_calc, \
    run_openpose_with_distance_and_degree_calc
...
result_file_path = '/Users/lucapomer/Documents/bachelor/YogaPoseDetection/distance_and_angles.csv'
...
for class_folder in os.listdir(images_folder):
    ...
    run_openpose_with_distance_and_degree_calc(full_class_path, result_file_path,
