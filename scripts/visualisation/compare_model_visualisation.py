...
gauss_model_dist = pickle.load(open('/models/Gauss_optimal_dist.sav', 'rb'))
gauss_model_angles = pickle.load(open('/models/Gauss_optimal_angles.sav', 'rb'))
gauss_model_both = pickle.load(open('/models/Gauss_optimal_both.sav', 'rb'))

scv_model_angles = pickle.load(open('/models/SVC_optimal_angles.sav', 'rb'))
scv_model_dist = pickle.load(open('/models/SVC_optimal_dist.sav', 'rb'))
scv_model_both = pickle.load(open('/models/SVC_optimal_both.sav', 'rb'))


tree_model_angles = pickle.load(open('/models/Tree_optimal_angles.sav', 'rb'))
tree_model_dist = pickle.load(open('/models/Tree_optimal_dist.sav', 'rb'))
tree_model_both = pickle.load(open('/models/Tree_optimal_both.sav', 'rb'))

mlp_model_angles = pickle.load(open('/models/Mlp_optimal_angles.sav', 'rb'))
mlp_model_dist = pickle.load(open('/models/Mlp_optimal_dist.sav', 'rb'))
mlp_model_both = pickle.load(open('/models/Mlp_optimal_both.sav', 'rb'))
